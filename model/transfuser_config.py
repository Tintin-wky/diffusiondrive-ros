...
import numpy as np
from .local_nuplan import TrajectorySampling
from .nuplan.tracked_objects_types import TrackedObjectType
from .nuplan.abstract_map import SemanticMapLayer
...
class TransfuserConfig:
    ...
    bkb_path: str = "/root/diffusiondrive/ckpts/resnet34.a1_in1k/pytorch_model.bin"
    plan_anchor_path: str = "/root/diffusiondrive/ckpts/kmeans_navsim_traj_20.npy"
    ...
    include_status_in_keyval: bool = True
